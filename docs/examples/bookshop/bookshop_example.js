...
const libCodeDemos=require('./demos');module.exports.demos=libCodeDemos.demos;module.exports.registerWithDocuserve=libCodeDemos.registerWithDocuserve;},{"./Pict-Code-Highlighter.js":15,"./Pict-Section-Code-DefaultConfiguration.js":16,"./demos":18,"pict-view":40}],18:[function(require,module,exports){/**
...
tmpEditor.focus();};};},{}],25:[function(require,module,exports){/**
...
for(let tmpIndex in this._richPreviewTimers){clearTimeout(this._richPreviewTimers[tmpIndex]);}this._richPreviewTimers={};this._richPreviewGenerations={};this._segmentTabStates={};}}module.exports=PictSectionMarkdownEditor;module.exports.default_configuration=_DefaultConfiguration;},{"./Pict-MDE-CodeMirror.js":22,"./Pict-MDE-DragAndReorder.js":23,"./Pict-MDE-Formatting.js":24,"./Pict-MDE-ImageHandling.js":25,"./Pict-MDE-RichPreview.js":26,"./Pict-Section-MarkdownEditor-DefaultConfiguration.js":27,"pict-section-content":19,"pict-view":40}],29:[function(require,module,exports){/**
 * Pict-Modal-Confirm
 *
...
fResolve(pResult);}/**
	 ...
	 * @param {string} pText
	 * @returns {string}
	 */_escapeHTML(pText){if(typeof pText!=='string'){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=PictModalConfirm;},{}],30:[function(require,module,exports){/**
 * Pict-Modal-Dropdown
 *
...
setTimeout(()=>{if(tmpElement.parentNode){tmpElement.parentNode.removeChild(tmpElement);}},220);this._element=null;this._currentClickHandler=null;}}}/**
	 ...
	 */destroy(){this._refCount=0;if(this._element&&this._element.parentNode){this._element.parentNode.removeChild(this._element);}this._element=null;this._currentClickHandler=null;}}module.exports=PictModalOverlay;},{}],32:[function(require,module,exports){/**
 * Pict-Modal-Panel
 *
...
let tmpHandle={id:tmpId,collapse:tmpCollapse,expand:tmpExpand,toggle:tmpToggle,setWidth:tmpSetWidth,destroy:tmpDestroy};this._panels.push(tmpHandle);return tmpHandle;}/**
	 ...
	 */destroyAll(){let tmpPanels=this._panels.slice();for(let i=0;i<tmpPanels.length;i++){tmpPanels[i].destroy();}}}module.exports=PictModalPanel;},{}],33:[function(require,module,exports){/**
...
if(tmpOptions.duration>0){tmpTimeoutHandle=setTimeout(tmpDismiss,tmpOptions.duration);}return tmpHandle;}/**
	 ...
	 * @param {string} pText
	 * @returns {string}
	 */_escapeHTML(pText){if(typeof pText!=='string'){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=PictModalToast;},{}],35:[function(require,module,exports){/**
 * Pict-Modal-Tooltip
 *
...
tmpLeft=Math.max(4,Math.min(tmpLeft,window.innerWidth-tmpTooltipRect.width-4));tmpTop=Math.max(4,Math.min(tmpTop,window.innerHeight-tmpTooltipRect.height-4));pTooltip.style.top=tmpTop+'px';pTooltip.style.left=tmpLeft+'px';}/**
	 ...
	 */dismissAll(){let tmpTooltips=this._modal._activeTooltips.slice();for(let i=0;i<tmpTooltips.length;i++){tmpTooltips[i].destroy();}}}module.exports=PictModalTooltip;},{}],36:[function(require,module,exports){/**
 * Pict-Modal-Window
 *
...
/**
	 ...
	 * @param {string} pText - Text to escape
	 * @returns {string} Escaped text
	 */_escapeHTML(pText){if(!pText){return'';}return pText.replace(/&/g,'&amp;').replace(/</g,'&lt;').replace(/>/g,'&gt;').replace(/"/g,'&quot;');}}module.exports=InlineDocumentationTopicManagerView;module.exports.default_configuration=_ViewConfiguration;},{"pict-view":40}]},{},[2])(2);});
